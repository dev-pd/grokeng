...
from app.models.message import Message, MessageCreate, MessageUpdate, MessageResponse, MessageListResponse
import logging
...
async def get_messages(
    ...
    grok_generated: Optional[bool] = Query(None, description="Filter by Grok-generated"),
...
async def get_message_stats(
    ...
    try:
        # Messages by type
        type_query = select(Message.message_type, func.count(Message.id)).group_by(Message.message_type)
